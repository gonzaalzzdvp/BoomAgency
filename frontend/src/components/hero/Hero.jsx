      ...
      <div className="flex flex-col gap-8 max-w-xl text-center md:text-left">
        ...
        <div className="flex items-start justify-center md:justify-start gap-4">
          <div className="flex flex-col leading-none">
            <h1 className="font-bold text-(--violetBoom) text-5xl sm:text-6xl md:text-7xl">
              Boom
            </h1>
            <h1 className="font-bold text-(--blueBoom) text-5xl sm:text-6xl md:text-7xl">
              Agency
            </h1>
          </div>
          ...
          <img
            ...
            alt="Megaphone"
            className="w-14 sm:w-16 md:w-20 self-start animate-bounce"
          />
        </div>
